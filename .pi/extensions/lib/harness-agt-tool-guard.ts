...
import { appendPolicyAuditEvent } from "../../lib/agt/audit-run-sink.js";
import type { BuildEvaluationContextInput } from "../../lib/agt/build-evaluation-context.js";
import { evaluateHarnessToolPolicy } from "../../lib/agt/evaluate-policy.js";
import { recordHarnessPolicyDeny } from "../../lib/agt/kill-switch-state.js";
import {
	recordPolicyAllow,
	recordPolicyDeny,
} from "../../lib/agt/trust-run-store.js";
...
export async function evaluateAgtHarnessToolCall(input: {
	moduleUrl: string;
	toolName: string;
