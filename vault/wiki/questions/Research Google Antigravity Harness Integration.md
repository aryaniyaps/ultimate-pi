...
Add headless browser control capability via Puppeteer/Playwright. Agents drive browser for visual verification of UI changes. Dispatched via P25 subagent router for UI tasks.
